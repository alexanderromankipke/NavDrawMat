...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Add the Second i.e Lecturer Fragment to the Container
//        Fragment lecturerFragment = new LecturerFragment();
//        FragmentTransaction lecturerTransaction = getSupportFragmentManager().beginTransaction();
//        fragmentTransaction.replace(R.id.containerView,lecturerFragment,null);
//        fragmentTransaction.commit();
