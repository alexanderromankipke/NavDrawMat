        ...
        public void onClick(View v) {
            ...
            switch (getPosition()){
                ...
                case 4:
                    ...
                    fragmentTransaction.replace(R.id.containerView,lecturerFragment);
                    fragmentTransaction.commit();
                    break;
//                case 5:
//                    Fragment lecturer2Fragment = new LecturerFragment();
//                    fragmentTransaction.replace(R.id.containerView,lecturer2Fragment);
//                    fragmentTransaction.commit();
//                    break;
            }
